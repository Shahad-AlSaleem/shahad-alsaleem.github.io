...
release: "06 Jul 2026"
ip: "192.168.109.10"
# Drop a real avatar at static/img/pg/blaze.png and uncomment:
# avatar: "/img/pg/blaze.png"
...
{{< htb name="Blaze" os="Linux" difficulty="Medium" release="06 Jul 2026" ip="192.168.109.10" platform="PG" >}}
...
![Blaze login page](/img/pg/blaze/01-login-page.png)
...
![Password dashboard leaking base64-encoded credentials for james and cameron](/img/pg/blaze/02-password-dashboard.png)
...
![Cockpit login screen accepting james's reused credentials](/img/pg/blaze/03-cockpit-login.png)

James's password logs straight in.

![Cockpit system overview for host blaze](/img/pg/blaze/04-cockpit-overview.png)

Cockpit ships a built-in terminal, no separate SSH session needed to explore further.

![Cockpit terminal showing sudo -l output for james](/img/pg/blaze/05-cockpit-terminal-sudo.png)
